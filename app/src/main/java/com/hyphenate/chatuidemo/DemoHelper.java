...
import com.shizhong.view.ui.base.db.DemoDBManager;
import com.shizhong.view.ui.base.db.InviteMessgeDao;
import com.shizhong.view.ui.base.db.UserDao;
		...
		eventListener = new EMEventListener() {
			...
			public void onEvent(EMNotifierEvent event) {
				...
				case EventReadAck:
					...
					// 判断接收到ack的这条消息是不是阅后即焚的消息，如果是，则说明对方看过消息了，对方会销毁，这边也删除(现在只有txt
					// iamge file三种消息支持 )
