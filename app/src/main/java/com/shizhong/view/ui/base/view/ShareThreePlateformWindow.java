...
public class ShareThreePlateformWindow extends PopupWindow implements OnClickListener, SnsPostListener {
	...
	public ShareThreePlateformWindow(Context context) {
	...
	public ShareThreePlateformWindow(Context context, int width, int height) {
		super(context);
		...
		case R.id.options_image:
			...
			case 0:
				if (mShareManager != null && this.shareBean != null) {
					...
					mShareManager.sharePlactformInfo((Activity) mContext, SHARE_MEDIA.SINA, shareBean, this);
				}
			...
			case 1:
				if (mShareManager != null && this.shareBean != null) {
					...
					mShareManager.sharePlactformInfo((Activity) mContext, SHARE_MEDIA.WEIXIN, shareBean, this);
				}
				break;
			case 2:
				if (mShareManager != null && this.shareBean != null) {
					LogUtils.i("sharebean", "share winxipengyouquan");
					mShareManager.sharePlactformInfo((Activity) mContext, SHARE_MEDIA.WEIXIN_CIRCLE, shareBean, this);
				}
				break;
			case 3:
				if (mShareManager != null && this.shareBean != null) {
					LogUtils.i("sharebean", "share qq");
					mShareManager.sharePlactformInfo((Activity) mContext, SHARE_MEDIA.QQ, shareBean, this);
				}
				break;
			case 4:
				if (mShareManager != null && this.shareBean != null) {
					LogUtils.i("sharebean", "share qzone");
					mShareManager.sharePlactformInfo((Activity) mContext, SHARE_MEDIA.QZONE, shareBean, this);
				}
				break;
