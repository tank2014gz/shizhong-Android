...
public class MemberAttentionAdapter extends BaseSZAdapter<UserExtendsInfo, MemberAttentionAdapter.ViewHolder>
		implements OnClickListener {

	private String login_token;

	public MemberAttentionAdapter(Context context, List<UserExtendsInfo> list) {
		super(context, list);
