...
public class BannerHolderView implements Holder<BannerBean>, OnClickListener {
	...
	public BannerHolderView(Context context, List<BannerBean> bannerBeanList) {
		mContext = context;
...
//				.error(R.drawable.banner_default_icon).diskCacheStrategy(DiskCacheStrategy.ALL).into(imageView);
	}
