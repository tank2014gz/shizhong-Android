package com.shizhong.view.ui.base.view.convenientbanner.adapter;
...
//        if(onItemClickListener != null) view.setOnClickListener(onItemClickListener);
    ...
    public CBPageAdapter(@SuppressWarnings("rawtypes") CBViewHolderCreator holderCreator, List<T> datas) {
