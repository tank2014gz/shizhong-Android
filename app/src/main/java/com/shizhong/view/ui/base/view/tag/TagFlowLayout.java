package com.shizhong.view.ui.base.view.tag;
	...
	private void changeAdapter() {
		...
		for (int i = 0; i < adapter.getCount(); i++) {
			...
			if (tagView.getLayoutParams() != null) {
				...
				lp.setMargins(UIUtils.dipToPx(getContext(), 5), UIUtils.dipToPx(getContext(), 5),
						UIUtils.dipToPx(getContext(), 5), UIUtils.dipToPx(getContext(), 5));
