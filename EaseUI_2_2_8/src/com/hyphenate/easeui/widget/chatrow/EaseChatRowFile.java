...
public class EaseChatRowFile extends EaseChatRow {
	...
	protected void onInflatView() {
		inflater.inflate(message.direct == EMMessage.Direct.RECEIVE ? R.layout.ease_row_received_file
	...
	protected void onBubbleClick() {
		...
		if (file != null && file.exists()) {
			...
			context.startActivity(
					new Intent(context, EaseShowNormalFileActivity.class).putExtra("msgbody", message.getBody()));
		}
