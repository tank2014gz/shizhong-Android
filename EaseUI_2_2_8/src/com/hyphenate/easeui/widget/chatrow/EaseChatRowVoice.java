...
public class EaseChatRowVoice extends EaseChatRowFile {
	...
	protected void onInflatView() {
		inflater.inflate(message.direct == EMMessage.Direct.RECEIVE ? R.layout.ease_row_received_voice
	...
	protected void onSetUpView() {
		...
		if (EaseChatRowVoicePlayClickListener.playMsgId != null
			...
			if (message.direct == EMMessage.Direct.RECEIVE) {
				voiceImageView.setImageResource(R.drawable.ease_chatfrom_voice_playing_f4);
			} else {
				voiceImageView.setImageResource(R.drawable.ease_chatto_voice_playing_f4);
			}
		}
